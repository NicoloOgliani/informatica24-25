/*Scrivi un programma che permetta all’utente di inserire 5 numeri interi
 e verifichi se questi numeri appartengono alla sequenza dei numeri naturali,
  cioè sono tutti differenti e hanno tra di loro distanza unitaria
 nella linea dei numeri. (ad esempio la sequenza 3-4-5-6-7 è una sequenza adeguata,
...
int main(){
    ...
    if(n2==n1+1&&n3==n2+1&&n4==n3+1&&n5==n4+1){
        printf("la sequenza è adeguata");
    }
    else{
        printf("la sequenza non è adeguata")
    }
